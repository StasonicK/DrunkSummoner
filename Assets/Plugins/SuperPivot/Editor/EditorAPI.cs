...
namespace SuperPivot
{
    public class EditorAPI
    {
        ...
        public static Transform WrapTransform(Transform towrap)
        {
            ...
            wrapper.SetPositionAndRotation(towrap.position, towrap.rotation); // the new pivot of the wrapper has the same position and rotation than the wrapped object
